...
import AddJcnModalCell from '../AddJcnModalCell'
...
export const Success = ({ debriefForm, variables }) => {
  ...
  const [updateDebreif] = useMutation(UPDATE_DEBRIEF)
  ...
  return (
    ...
    >
      ...
      >
        <AddJcnModalCell unit_id={debriefForm.unit_id} />
      </AddJcnModalContext.Provider>
      <Box label={'Sortie Header'} sx={{ borderBottom: '3px solid black' }}>
        <Box
          sx={{
            display: 'flex',
            flexDirection: 'row',
        ...
        >
          ...
          >
            ...
            />
            <Stack>
              <Box sx={{ display: 'inline-flex', width: '50VW' }}>
                <Typography
                  variant="h4"
                  sx={{ textAlign: 'left', margin: '0px', minWidth: '20%' }}
                >
                  {sortie.aircraft_id.toString().substring(0, 2) +
                    '-' +
                    sortie.aircraft_id.toString().substring(2)}
                </Typography>
                {aircraft.name ? (
                  <Typography
                    variant="h5"
                    sx={{ textAlign: 'left', margin: '8px' }}
                  >
                    {aircraft.name}
                  </Typography>
                ) : null}
          ...
          <Box sx={{ padding: '0 5%' }}>
            {hasRole('debrief') &&
              (editable ? (
                <Button variant="outlined" type="submit" form="debrief">
                  Update
                </Button>
              ) : (
                <Button variant="outlined" type="submit" form="debrief">
      ...
      >
        <Box label={'Debrief Questions'} sx={{ margin: '10px', width: '40%' }}>
          <FormGroup>
            <Form
              id="debrief"
              onSubmit={(event) => {
              ...
              disabled="true"
            >
              <fieldset disabled={userRole}>
                <Typography variant="h4">Debrief Form</Typography>
                <Box label={'Variant Input Questions'}>
                  <Grid container>
                    <Grid item xs={6}>
                      <Typography sx={{ paddingRight: '28%' }}>
                        Had Aerial Refuel:
                      </Typography>
                    </Grid>
                    <Grid item xs={6}>
                  ...
                  <FormControl fullWidth>
                    <TextField
                      ...
                      id="landing_fuel"
                      label="Landing Fuel"
                      defaultValue={aircraft.fuel_quant}
                      onChange={handleInput}
                      sx={{ padding: '10px 0px' }}
                    />
                  </FormControl>
                ...
                >
                  <Grid item xs={6}>
                    <Typography>Bird Strike:</Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Stack direction="row" spacing={1} alignItems="center">
                      <Typography>No</Typography>
                  ...
                  <Grid item xs={6}>
                    <Typography>Drag Chute:</Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Stack direction="row" spacing={1} alignItems="center">
                      <Typography>No</Typography>
                  ...
                  <Grid item xs={6}>
                    <Typography>Hung Store:</Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Stack direction="row" spacing={1} alignItems="center">
                      <Typography>No</Typography>
                  ...
                  <Grid item xs={6}>
                    <Typography>Bomb Door Actuation:</Typography>
                  </Grid>
                  <Grid item xs={6}>
                    <Stack direction="row" spacing={1} alignItems="center">
                      <Typography>No</Typography>
                  ...
                  <Grid item xs={6}>
                    <Box fullWidth alignItems="center">
                      <Typography>Landing Status:</Typography>
                    </Box>
                  </Grid>
                  <Grid item xs={6}>
                    <Stack>
        ...
        >
          <Box fullWidth sx={{ justifyContent: 'center' }}>
            ...
            >
              <Typography variant="h5">Open Discrepancies</Typography>
              <Button
                variant="contained"
                sx={{ height: '35px', marginBottom: '10px' }}
